...
\begin{table}[h]
  ...
  \adjustimage{width=6cm,valign=c}{example-image}\quad%
  \begin{tabular}{ |c| c| }
      \hline
   $x$ & $y$ \\ 
   \hline
...
\noindent
S slednjim generiranim seznamom točk poženimo pogram, ki nam vrne naslednji matriki $B$ in $C.$
\newline
...
\noindent
V matriki $B$ na mestu $[7,7]$ najdemo dolžino bitonične poti za naš problem potujočega trgovca. 
